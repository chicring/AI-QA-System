...
public class Keys {
    ...
    public static final UniqueKey<QuestionFavoriteRecord> KEY_QA_QUESTION_FAVORITE_PRIMARY = Internal.createUniqueKey(QuestionFavoriteTb.QA_QUESTION_FAVORITE, DSL.name("KEY_qa_question_favorite_PRIMARY"), new TableField[] { QuestionFavoriteTb.QA_QUESTION_FAVORITE.ID }, true);
    public static final UniqueKey<QuestionHistoryRecord> KEY_QA_QUESTION_HISTORY_PRIMARY = Internal.createUniqueKey(QuestionHistoryTb.QA_QUESTION_HISTORY, DSL.name("KEY_qa_question_history_PRIMARY"), new TableField[] { QuestionHistoryTb.QA_QUESTION_HISTORY.ID }, true);
    ...
    public static final UniqueKey<NotificationRecord> KEY_SYS_NOTIFICATION_PRIMARY = Internal.createUniqueKey(NotificationTb.SYS_NOTIFICATION, DSL.name("KEY_sys_notification_PRIMARY"), new TableField[] { NotificationTb.SYS_NOTIFICATION.ID }, true);
