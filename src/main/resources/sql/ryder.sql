...
CREATE TABLE `qa_answer` (
                             ...
                             `extended_filed` varchar(200) DEFAULT NULL COMMENT '额外内容',
...
CREATE TABLE `sys_role` (
                            ...
                            `level` int DEFAULT NULL COMMENT '角色级别：0-9，数字越小级别越高',
                            `type` tinyint DEFAULT NULL COMMENT '角色类型：1-内置，2-自定义',
